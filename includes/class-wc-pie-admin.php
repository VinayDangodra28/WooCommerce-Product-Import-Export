...
class WC_PIE_Admin
{
    ...
    public function enqueue_scripts($hook)
    {
        if (strpos($hook, 'product-import-export') !== false || strpos($hook, 'product-export') !== false || strpos($hook, 'product-import') !== false) {
            ...
            wp_enqueue_script('product-ie-script', $this->plugin_url . 'assets/js/script.js', array('jquery'), '1.0.3', true);
            wp_enqueue_style('product-ie-style', $this->plugin_url . 'assets/css/style.css', array(), '1.0.3');
                    ...
                    <div class="pie-options-grid">
                        <div class="pie-option-group">
                            ...
                            <label class="pie-radio-item">
                                <input type="checkbox" name="import_status" value="draft" checked />
                                <span class="pie-radio-content">
                                    <span class="pie-radio-title">Import Products as Draft</span>
                                </span>
                            </label>
                            <label class="pie-option-item">
